...
from lib.utils import load_image, load_model, cuda_available
from lib.utils import preprocess_image, apply_color, choose_tlayer
...
class GradCAM():
    def __init__(self,
        ...
        self.model = load_model(model_name, self.model_path)
    ...
    def __call__(self):
        ...
        gradcam = apply_color(gradcam, self.img)
