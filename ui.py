...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.page2_graphicsView, 3, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.tabWidget, 2, 4, 1, 1)
        self.page2_tableWidget = QtWidgets.QTableWidget(self.paint_page)
        self.page2_tableWidget.setAlternatingRowColors(True)
        ...
        self.page2_tableWidget.horizontalHeader().setHighlightSections(True)
        ...
        self.gridLayout_2.addWidget(self.page2_tableWidget, 1, 0, 3, 4)
        ...
        self.gridLayout_2.addWidget(self.page2_zoom, 3, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_build, 0, 2, 1, 1)
        self.page2_load_clip_board = QtWidgets.QPushButton(self.paint_page)
        self.page2_load_clip_board.setObjectName("page2_load_clip_board")
        self.gridLayout_2.addWidget(self.page2_load_clip_board, 0, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.page3_category, 0, 4, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.page3_grad_cam_method, 1, 4, 1, 1)
        self.page3_open_model_path = QtWidgets.QPushButton(self.page_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.page3_open_model_path.sizePolicy().hasHeightForWidth())
        self.page3_open_model_path.setSizePolicy(sizePolicy)
        self.page3_open_model_path.setMaximumSize(QtCore.QSize(30, 30))
        self.page3_open_model_path.setObjectName("page3_open_model_path")
        self.gridLayout_4.addWidget(self.page3_open_model_path, 0, 2, 1, 1)
        ...
        self.page3_model_name.addItem("")
        self.page3_model_name.addItem("")
        self.gridLayout_4.addWidget(self.page3_model_name, 1, 1, 1, 2)
        ...
        self.page3_target_layer.addItem("")
        self.gridLayout_4.addWidget(self.page3_target_layer, 2, 1, 1, 2)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(168, 25, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.toolBar.setToolTipDuration(2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "DL-Viewer"))
        ...
        self.page2_load_clip_board.setText(_translate("MainWindow", "Load from clipboard"))
        ...
        self.page3_open_model_path.setText(_translate("MainWindow", "…"))
        ...
        self.page3_model_name.setItemText(8, _translate("MainWindow", "custom"))
        ...
        self.actionDraw_Fig.setToolTip(_translate("MainWindow", "Plot"))
